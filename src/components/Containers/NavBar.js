...
const NavBar = () => {
    return (
        <div className="NavBar">
            <div className="navBarElement"> <Link to="/"> <img className="logo" src="../images/logo.png" alt="logo"/></Link></div>
            ...
            <div className="navBarElement"><Link to="/account/"> Cuenta </Link></div>
            <CartWidget/>
        </div>
    )
}
